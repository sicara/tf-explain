...
def mnist_dataset(num_classes):
    ...
    return train_images[0:500], train_labels[0:500], test_images[0:300], test_labels[0:300]
...
def validation_dataset(mnist_dataset, num_classes):
    ...
    ONE_HOT_TARGET_CLASS = np.array([int(el == TARGET_CLASS) for el in range(num_classes)])
